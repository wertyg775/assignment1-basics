...
def run_multihead_self_attention(
    ...
    """
    mha = attention.CausalMultiHeadSelfAttention(d_model, num_heads)
    proj_dict = {
...
def run_multihead_self_attention_with_rope(
    ...
    Returns:
        ...
        implementation with the given QKV projection weights and input features.
    """
    rope = attention.RotaryPositionalEmbedding(theta, d_model // num_heads, max_seq_len)
    mha = attention.CausalMultiHeadSelfAttention(d_model, num_heads, rope=rope)
    proj_dict = {
            "q_proj.weight": q_proj_weight,
            "k_proj.weight": k_proj_weight,
            "v_proj.weight": v_proj_weight,
...
def run_rope(
    ...
    """
    rope = attention.RotaryPositionalEmbedding(theta, d_k, max_seq_len)
...
def run_rmsnorm(
    ...
    """
    rms_norm = mynn.RMSNorm(d_model, eps)
    state_dict = {"weight": weights}
...
def run_cross_entropy(
    ...
    """
    return mynn.cross_entropy(inputs, targets)
...
def get_tokenizer(
    ...
    """
    tokenizer = tok.Tokenizer(vocab, merges, special_tokens)
    return tokenizer
